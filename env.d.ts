/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./env.d.ts` (hash: 245b9e809a02ae13c0e6bd293dd5cf88)
// Runtime types generated with workerd@1.20250709.0 2025-06-20 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		AUTH_GOOGLE_ID: "255807240303-5i2dilip2tro0ldtanqioj90d9hglbua.apps.googleusercontent.com";
		users: D1Database;
		challenges: D1Database;
		calendar: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_GOOGLE_ID">> {}
}
