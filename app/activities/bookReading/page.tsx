...
const viewVariants = {
  ...
  exit: {
    ...
    y: -30,
    scale: 0.98,
    transition: { duration: 0.3, ease: [0.6, 0.04, 0.98, 0.34] },
  },
};
...
export default function BookReadingActivity() {
  ...
  const getButtonState = () => {
    ...
    if (logSuccess === true)
      return { text: "✓ Activity Logged!", color: "#16A34A" }; // green-600
    if (logSuccess === false)
      return { text: "✗ Logging Failed", color: "#DC2626" }; // red-600
  ...
  return (
    ...
    >
      <div className="max-w-xl w-full p-6 text-orange-600">
        ...
        >
          <span role="img" aria-label="book" className="text-4xl">
            📖
          </span>
          {t("bookReading")}
        </motion.h1>
            ...
            >
              ...
              >
                <motion.button
                  ...
                  className="px-5 py-2 rounded-lg font-semibold text-white bg-yellow-500"
                ...
                <motion.button
                  onClick={handleStop}
                  className="px-5 py-2 rounded-lg font-semibold text-white bg-red-500"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  {t("stop")}
          ...
          {isSessionComplete && (
            ...
            >
              <div className="text-center">
                ...
                <p className="text-lg mt-2 mb-6">{t("greatJob")}</p>
              </div>
              <motion.button
                ...
                whileHover={{
                  scale: isLogging || logSuccess !== null ? 1 : 1.03,
                }}
                whileTap={{
                  scale: isLogging || logSuccess !== null ? 1 : 0.97,
                }}
              >
                {isLogging
                  ? t("logging")
