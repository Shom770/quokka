...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`flex flex-col items-center bg-[#E2EDFF] ${figtree.className} antialiased bg-blue-100 overflow-hidden`}
      >
        <Navbar />
        <div className="flex flex-col items-center justify-center w-screen h-[85vh] overflow-x-hidden">
