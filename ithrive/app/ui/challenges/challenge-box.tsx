...
export default function ChallengeBox({ category, description }: { category: string, description: string }) {
    ...
    return (
        <button
            className={`duration-200 flex flex-col items-center justify-center gap-2 basis-1/4 aspect-square rounded-xl ${!pressed ? 'bg-blue-500/10 border border-blue-500 text-blue-500' : 'bg-blue-500 text-white'}`}
